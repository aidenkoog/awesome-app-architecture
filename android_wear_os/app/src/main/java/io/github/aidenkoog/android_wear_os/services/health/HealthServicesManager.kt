...
package io.github.aidenkoog.android_wear_os.services.health
...
class HealthServicesManager @Inject constructor(
    ...
    suspend fun startExercise() {
        ...
        val dataTypes = setOf(
            DataType.HEART_RATE_BPM, DataType.CALORIES_TOTAL, DataType.DISTANCE
    ...
    suspend fun prepareExercise() {
        Logger.d("Preparing an exercise")
        ...
        try {
            ...
            Logger.e("Prepare exercise failed - ${e.message}")
        }
    }

    suspend fun endExercise() {
        Logger.d("Ending exercise")
        exerciseClient.endExerciseAsync().await()
    }

    suspend fun pauseExercise() {
        Logger.d("Pausing exercise")
        exerciseClient.pauseExerciseAsync().await()
    }

    suspend fun resumeExercise() {
        Logger.d("Resuming exercise")
