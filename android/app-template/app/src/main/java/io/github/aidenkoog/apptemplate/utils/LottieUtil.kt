    ...
    fun addLottieAnimatorListener(view: LottieAnimationView, listener: LottieAnimatorListener?) {
        view.addAnimatorListener(object : Animator.AnimatorListener {
            override fun onAnimationStart(animator: Animator) {
                Timber.i("Lottie animation is started")
                listener?.onAnimationStart(animator)
            }

            override fun onAnimationEnd(animator: Animator) {
                Timber.i("Lottie animation is ended")
                listener?.onAnimationEnd(animator)
            }

            override fun onAnimationCancel(animator: Animator) {
                Timber.i("Lottie animation is canceled")
                listener?.onAnimationCancel(animator)
            }

            override fun onAnimationRepeat(animator: Animator) {
                Timber.i("Lottie animation is repeated")
