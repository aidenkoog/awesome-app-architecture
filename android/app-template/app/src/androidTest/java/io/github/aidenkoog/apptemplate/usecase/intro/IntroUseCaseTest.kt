package io.github.aidenkoog.apptemplate.usecase.intro
...
class IntroUseCaseTest {
    ...
    // Testcase 1. Get intro app info data information.
    @ExperimentalCoroutinesApi
    @Test
    fun getIntroAppInfo() = runTest {
        println("Testcase 1. Get intro app info data")
        launch {
        ...
        println("Testcase 1. End - Get intro app info data")
    }
}