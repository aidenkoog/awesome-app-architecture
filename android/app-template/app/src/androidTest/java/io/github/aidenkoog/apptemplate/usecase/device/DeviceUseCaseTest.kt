package io.github.aidenkoog.apptemplate.usecase.device
...
class DeviceUseCaseTest {
    ...
    // Testcase 1. Get device data information.
    @ExperimentalCoroutinesApi
    @Test
    fun getDevices() = runTest {
        println("Testcase 1. Get device data")
        launch {
        ...
        println("Testcase 1. End - Get device data")
    }
}