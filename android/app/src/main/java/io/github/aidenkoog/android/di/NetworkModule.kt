...
import io.github.aidenkoog.android.data.repository.DeviceRepositoryImpl
import io.github.aidenkoog.android.data.repository.InitAppRepositoryImpl
...
class NetworkModule {
    ...
    fun providesOkHttpClient(
        ...
        val client = OkHttpClient.Builder()
            ...
            .addInterceptor { chain ->
                 ...
                 */
                request =
                        //make default to true till i figure out how to inject network status
                    if (true) {
                        request.newBuilder()
    ...
    fun provideDeviceRepository(
        ...
        return DeviceRepositoryImpl(retrofitService)
    }

    @Singleton
    @Provides
    fun provideInitAppRepository(
        retrofitService: RetrofitService
    ): InitAppRepository {
        return InitAppRepositoryImpl(retrofitService)
    }
}