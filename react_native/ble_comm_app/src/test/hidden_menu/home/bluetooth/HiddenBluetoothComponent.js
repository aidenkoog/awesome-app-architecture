...
export default function HiddenBluetoothComponent(props) {
     ...
     */
    const {
        onPressTestCase, logMessages, handleOkPopup, handleCancelPopup,
        onDeviceNameChanged, onDeviceMacAddressChanged, okButtonDisable,
        nameErrorHintMessage, macAddressErrorHintMessage, popupVisible,
    } = props
                ...
                <View style={{ flexDirection: "column" }}>
                    <View style={{
                        ...
                        <TextInput
                            ...
                            style={{
                                flex: 1, fontSize: 14, alignItems: "center",
                                height: null, backgroundColor: "#000000", color: "#ffff00"
                            }}
                        />
                    </View>
                    <Text style={{ color: "#cc3340", fontWeight: "bold" }}>{nameErrorHintMessage}</Text>

                    <View style={{
                        flexDirection: "row", justifyContent: "flex-start", alignItems: "center", marginTop: 15
                    }}>
                    ...
                    <Text style={{ color: "#cc3340", fontWeight: "bold" }}>{macAddressErrorHintMessage}</Text>

                    <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center", marginTop: 30 }}>
                        <Dialog.Button style={styles.popupButton}
                            label="Cancel" onPress={handleCancelPopup}></Dialog.Button>

                        <Dialog.Button style={styles.popupButton}
                            disabled={okButtonDisable}
                            label="OK" onPress={handleOkPopup}></Dialog.Button>
                    </View>
                </View>
            </Dialog.Container>
        </View>
